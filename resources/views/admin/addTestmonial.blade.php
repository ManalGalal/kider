          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">New Testmonial</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form action="{{ route('storeTestmonial') }}"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Client Name </label>
                    <input type="text" name="clientName" class="form-control" id="exampleInputEmail1" placeholder="Client Name">
                  </div>
                  @error("clientName")
                ...
                @enderror
                  <div class="form-group">
                    ...
                    <input type="test" name="title" class="form-control" id="exampleInputPassword1" placeholder="Title">
                  </div>
                  @error("title")
                  <p style="color: red">{{$message}}</p>
                @enderror
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input name="clientImage" type="file" class="custom-file-input" id="exampleInputFile">
                 ...
                 @enderror
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="review" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                  </div>
                </div>
                @error("review")
                <p style="color: red">{{$message}}</p>
